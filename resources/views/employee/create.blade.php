    ...
    <div id="page" class="container">
      ...
      <form method="POST" action="/admin/employees">
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input @error('first_name') is-danger @enderror" type="text" name="first_name" id="" value="{{ old('first_name') }}" />
            @error('first_name')
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input @error('last_name') is-danger @enderror" type="text" name="last_name" id="" value="{{ old('last_name') }}" />
            @error('last_name')
	  ...
	  @enderror
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input @error('phone') is-danger @enderror" type="text" name="phone" id="" value="{{ old('phone') }}" />
            @error('phone')
